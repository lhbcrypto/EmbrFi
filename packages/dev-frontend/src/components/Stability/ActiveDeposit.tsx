    ...
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
                ...
                <InfoIcon
                  tooltip={
                    <Card variant="tooltip" sx={{ width: "240px" }}>
                      Although the EMBR rewards accrue every minute, the value on the UI only updates
        ...
        <Flex variant="layout.actions">
          ...
          <ClaimRewards disabled={!hasGain && !hasReward}>Claim BTC.b and EMBR</ClaimRewards>
        </Flex>

        {hasTrove && (
          <ClaimAndMove disabled={!hasGain}>Claim EMBR and move BTC.b to Trove</ClaimAndMove>
        )}
      </Box>
