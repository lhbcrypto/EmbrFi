  ...
  return (
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        ...
        <StaticRow
          ...
          infoIcon={
            <InfoIcon
              tooltip={
                <Card variant="tooltip" sx={{ width: "240px" }}>
                  The total amount of EUSD your Trove will hold.{" "}
                  {isDirty && (
                    <>
                      You will need to repay {totalDebt.sub(LUSD_LIQUIDATION_RESERVE).prettify(2)}{" "}
                      EUSD to reclaim your collateral ({LUSD_LIQUIDATION_RESERVE.toString()} EUSD
        ...
        {description ?? (
          <ActionDescription>
            Start by entering the amount of BTC.b you'd like to deposit as collateral.
          </ActionDescription>
        )}
